<template>
  <div class="main-page-content">
    <el-card shadow="always" :body-style="{ padding: '20px' }">
      ...
      <!-- card body -->
      <el-form ref="formRef" class="form-wrap" :model="modelRef" :rules="rules" label-width="120px">
        <el-form-item label="任务名称" prop="task_name">
          <el-input v-model="modelRef.task_name" placeholder="请输入任务名称" />
        </el-form-item>
        <el-form-item label="目标客户" prop="target_id">
        ...
        <el-form-item>
          <el-button type="primary" :loading="executeLoading" @click="executeTask">立即创建</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
