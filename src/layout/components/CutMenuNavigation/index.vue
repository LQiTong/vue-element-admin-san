    ...
    <el-scrollbar wrap-class="scrollbar-wrapper">
      ...
      >
        ...
        <el-scrollbar wrap-class="scrollbar-wrapper">
          ...
          >
            <sidebar-item
              v-for="route in selectedMenu"
              :key="route.path"
              :item="route"
              :base-path="parentPath ? parentPath + '/' + route.path : route.path"
            />
          </el-menu>
        </el-scrollbar>
      </el-popover>
...
export default {
  ...
  created() {
    console.log('====================================')
    console.log('dashboardRoutes ---> ', this.dashboardRoutes[0])
    console.log('====================================')
  },
  // 生命周期 - 挂载完成（可以访问DOM元素）
  mounted() {
